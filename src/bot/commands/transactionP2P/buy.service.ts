...
@Injectable()
export class TransactionP2PService {
    ...
    try {
      ...
      if (typeButtonRes === EmbebButtonType.SELL) {
        ...
        for (const buyOrder of parsedOrders) {
          ...
          const transactions = await this.transactionP2PRepository.find({
            where: { clanId: clanId || '', deleted: false },
          });
          ...
          const embedbuy = [
            {
              color,
              title: `[Buy]`,
              description: `${findUser.username} đã yêu cầu giao dịch ${buyOrder.id}, hãy liên hệ với họ`,
              timestamp: new Date().toISOString(),
              footer: MEZON_EMBED_FOOTER,
            },
          ];
          ...
          const embedSell = [
            {
              color,
              title: `[Sell]`,
              description: `Bạn đang yêu cầu giao dịch ${buyOrder.id} với ${buyer.username}, hãy liên hệ với họ`,
              timestamp: new Date().toISOString(),
              footer: MEZON_EMBED_FOOTER,
            },
          ];
        ...
        const embedbuy = [
          {
            color,
            title: `[Buy]`,
            description: `${findUser.username} đã yêu cầu hủy giao dịch ${transacionId}, hãy confirm nếu không có vẫn đề gì và hoặc report để báo cáo admin`,
            timestamp: new Date().toISOString(),
            footer: MEZON_EMBED_FOOTER,
          },
        ];
        ...
        const embedbuy = [
          {
            color,
            title: `[Buy]`,
            description: `Bạn đã xác nhận yêu cầu hủy giao dịch ${transacionId}`,
            timestamp: new Date().toISOString(),
            footer: MEZON_EMBED_FOOTER,
          },
        ];
        ...
        const embedSell = [
          {
            color,
            title: `[Sell]`,
            description: `${buyer.username} đã xác nhận yêu cầu hủy giao dịch ${transacionId}`,
            timestamp: new Date().toISOString(),
            footer: MEZON_EMBED_FOOTER,
          },
        ];
        ...
        const embed = [
          {
            color,
            title: `[Report]`,
            description: `Giao dịch ${transacionId} đã báo cáo đến admin, hãy liên hệ ${bot.invitor[clanId]} để được phản hồi sớm nhất`,
            timestamp: new Date().toISOString(),
            footer: MEZON_EMBED_FOOTER,
          },
        ];
        ...
        const embedAdmin = [
          {
            color,
            title: `[report]`,
            description: `${usernamereport} đã gửi báo cáo giao dịch ${transacionId}`,
            timestamp: new Date().toISOString(),
            footer: MEZON_EMBED_FOOTER,
          },
        ];
        ...
        const embed = [
          {
            color,
            title: `[Buy]`,
            description: `Giao dịch ${transacionId} đã được hoàn thành`,
            timestamp: new Date().toISOString(),
            footer: MEZON_EMBED_FOOTER,
          },
        ];
